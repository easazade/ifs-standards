...
export interface Action {
  ...
  warnings?: string;
  /**
   * Whether the action is performed inside the IFS system, outside the system, or across both.
   */
  executionContext: "internal" | "external" | "hybrid";
  /**
   * Lifecycle state of the action.
   */
  state: "drafted" | "under-review" | "active" | "suspended" | "revoked" | "deprecated";
  /**
   * Identifier of the scope where this action is defined or recognized.
   */
  scopeId?: string;
  /**
   * Identifier list of permissions that can authorize this action.
   */
  permissionIds?: string[];
  /**
   * Permission entities that can authorize this action.
   */
