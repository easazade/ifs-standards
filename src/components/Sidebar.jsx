...
export function Sidebar() {
  return (
    <aside className="w-60 shrink-0 border-r border-slate-200 bg-white p-4" aria-label="Section navigation">
      <p className="mb-3 text-xs font-medium uppercase tracking-wide text-slate-500">Protocols</p>
