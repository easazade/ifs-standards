...
const navLinkClass = ({ isActive }) =>
  [
    ...
    isActive ? 'font-semibold underline decoration-text underline-offset-4' : 'hover:bg-overlay',
  ].join(' ');

export function Navbar() {
  return (
    <header className="flex h-[52px] shrink-0 items-center justify-between border-b border-highlight-high bg-surface px-5">
      <span className="font-bold text-text">IFS Standards</span>
